...
import (
	...
	modulev1 "github.com/airchains-network/junction/api/junction/cipherpodledger/module"
	"github.com/airchains-network/junction/x/cipherpodledger/client/cli"
...
type ModuleInputs struct {
	...
	AccountKeeper   types.AccountKeeper
	BankKeeper      types.BankKeeper
	JunctionKeeper  types.JunctionKeeper
	WasmKeeper      types.WasmKeeper
	TrackgateKeeper types.TrackgateKeeper
...
type ModuleOutputs struct {
	...
	CipherpodledgerKeeper keeper.Keeper
...
func ProvideModule(in ModuleInputs) ModuleOutputs {
	...
	return ModuleOutputs{CipherpodledgerKeeper: k, Module: m}
}
