...
func (m *QueryListStationPodsRequest) Reset()         { *m = QueryListStationPodsRequest{} }
func (m *QueryListStationPodsRequest) String() string { return proto.CompactTextString(m) }
func (*QueryListStationPodsRequest) ProtoMessage()    {}
func (*QueryListStationPodsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_e6eb67fc8cb2f8ec, []int{20}
}
func (m *QueryListStationPodsRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryListStationPodsRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryListStationPodsRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryListStationPodsRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryListStationPodsRequest.Merge(m, src)
}
func (m *QueryListStationPodsRequest) XXX_Size() int {
	return m.Size()
}
func (m *QueryListStationPodsRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryListStationPodsRequest.DiscardUnknown(m)
}

var xxx_messageInfo_QueryListStationPodsRequest proto.InternalMessageInfo

func (m *QueryListStationPodsRequest) GetStationId() string {
	if m != nil {
		return m.StationId
	}
	return ""
...
func (m *QueryListStationPodsRequest) GetPagination() *query.PageRequest {
	if m != nil {
		return m.Pagination
	}
	return nil
...
type QueryListStationPodsResponse struct {
	Pods       []Pods              `protobuf:"bytes,1,rep,name=pods,proto3" json:"pods"`
	Pagination *query.PageResponse `protobuf:"bytes,2,opt,name=pagination,proto3" json:"pagination,omitempty"`
}

func (m *QueryListStationPodsResponse) Reset()         { *m = QueryListStationPodsResponse{} }
func (m *QueryListStationPodsResponse) String() string { return proto.CompactTextString(m) }
func (*QueryListStationPodsResponse) ProtoMessage()    {}
func (*QueryListStationPodsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_e6eb67fc8cb2f8ec, []int{21}
}
func (m *QueryListStationPodsResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryListStationPodsResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryListStationPodsResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryListStationPodsResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryListStationPodsResponse.Merge(m, src)
}
func (m *QueryListStationPodsResponse) XXX_Size() int {
	return m.Size()
}
func (m *QueryListStationPodsResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryListStationPodsResponse.DiscardUnknown(m)
}

var xxx_messageInfo_QueryListStationPodsResponse proto.InternalMessageInfo

func (m *QueryListStationPodsResponse) GetPods() []Pods {
	if m != nil {
		return m.Pods
	}
	return nil
...
func (m *QueryListStationPodsResponse) GetPagination() *query.PageResponse {
	if m != nil {
		return m.Pagination
	}
	return nil
...
func (m *QueryListStationPodsCustomPaginationRequest) Reset() {
	*m = QueryListStationPodsCustomPaginationRequest{}
}
func (m *QueryListStationPodsCustomPaginationRequest) String() string {
...
func (*QueryListStationPodsCustomPaginationRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_e6eb67fc8cb2f8ec, []int{22}
}
func (m *QueryListStationPodsCustomPaginationRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryListStationPodsCustomPaginationRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryListStationPodsCustomPaginationRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryListStationPodsCustomPaginationRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryListStationPodsCustomPaginationRequest.Merge(m, src)
}
func (m *QueryListStationPodsCustomPaginationRequest) XXX_Size() int {
	return m.Size()
}
func (m *QueryListStationPodsCustomPaginationRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryListStationPodsCustomPaginationRequest.DiscardUnknown(m)
}

var xxx_messageInfo_QueryListStationPodsCustomPaginationRequest proto.InternalMessageInfo

func (m *QueryListStationPodsCustomPaginationRequest) GetStationId() string {
	if m != nil {
		return m.StationId
	}
	return ""
...
func (m *QueryListStationPodsCustomPaginationRequest) GetOffset() uint64 {
	if m != nil {
		return m.Offset
	}
	return 0
...
func (m *QueryListStationPodsCustomPaginationRequest) GetLimit() uint64 {
	if m != nil {
		return m.Limit
	}
	return 0
...
func (m *QueryListStationPodsCustomPaginationRequest) GetOrder() string {
	if m != nil {
		return m.Order
	}
	return ""
...
func (m *QueryListStationPodsCustomPaginationResponse) Reset() {
	*m = QueryListStationPodsCustomPaginationResponse{}
}
func (m *QueryListStationPodsCustomPaginationResponse) String() string {
	return proto.CompactTextString(m)
}
...
func (*QueryListStationPodsCustomPaginationResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_e6eb67fc8cb2f8ec, []int{23}
}
func (m *QueryListStationPodsCustomPaginationResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryListStationPodsCustomPaginationResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryListStationPodsCustomPaginationResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryListStationPodsCustomPaginationResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryListStationPodsCustomPaginationResponse.Merge(m, src)
}
func (m *QueryListStationPodsCustomPaginationResponse) XXX_Size() int {
	return m.Size()
}
func (m *QueryListStationPodsCustomPaginationResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryListStationPodsCustomPaginationResponse.DiscardUnknown(m)
}

var xxx_messageInfo_QueryListStationPodsCustomPaginationResponse proto.InternalMessageInfo

func (m *QueryListStationPodsCustomPaginationResponse) GetPods() []Pods {
	if m != nil {
		return m.Pods
	}
	return nil
...
func (m *QueryListStationPodsCustomPaginationResponse) GetPagination() *JunctionPaginationResponse {
	if m != nil {
		return m.Pagination
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*QueryListStationPodsRequest)(nil), "junction.junction.QueryListStationPodsRequest")
	proto.RegisterType((*QueryListStationPodsResponse)(nil), "junction.junction.QueryListStationPodsResponse")
	proto.RegisterType((*QueryListStationPodsCustomPaginationRequest)(nil), "junction.junction.QueryListStationPodsCustomPaginationRequest")
	proto.RegisterType((*QueryListStationPodsCustomPaginationResponse)(nil), "junction.junction.QueryListStationPodsCustomPaginationResponse")
}
...
var fileDescriptor_e6eb67fc8cb2f8ec = []byte{
	...
	,
}
...
func (c *queryClient) ListStationPods(ctx context.Context, in *QueryListStationPodsRequest, opts ...grpc.CallOption) (*QueryListStationPodsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/junction.junction.Query/ListStationPods", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) ListStationPodsCustomPagination(ctx context.Context, in *QueryListStationPodsCustomPaginationRequest, opts ...grpc.CallOption) (*QueryListStationPodsCustomPaginationResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/junction.junction.Query/ListStationPodsCustomPagination", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedQueryServer) ListStationPods(ctx context.Context, req *QueryListStationPodsRequest) (*QueryListStationPodsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListStationPods not implemented")
}
func (*UnimplementedQueryServer) ListStationPodsCustomPagination(ctx context.Context, req *QueryListStationPodsCustomPaginationRequest) (*QueryListStationPodsCustomPaginationResponse, error) {
...
func _Query_ListStationPods_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/junction.junction.Query/ListStationPods",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_ListStationPodsCustomPagination_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/junction.junction.Query/ListStationPodsCustomPagination",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func (m *QueryListStationPodsRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryListStationPodsRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryListStationPodsRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryListStationPodsResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryListStationPodsResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryListStationPodsResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryListStationPodsCustomPaginationRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryListStationPodsCustomPaginationRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryListStationPodsCustomPaginationRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryListStationPodsCustomPaginationResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryListStationPodsCustomPaginationResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryListStationPodsCustomPaginationResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryListStationPodsRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryListStationPodsResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryListStationPodsCustomPaginationRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryListStationPodsCustomPaginationResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryListStationPodsRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryListStationPodsRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryListStationPodsRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *QueryListStationPodsResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryListStationPodsResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryListStationPodsResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *QueryListStationPodsCustomPaginationRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryListStationPodsCustomPaginationRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryListStationPodsCustomPaginationRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *QueryListStationPodsCustomPaginationResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryListStationPodsCustomPaginationResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryListStationPodsCustomPaginationResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			...
			if m.Pagination == nil {
				m.Pagination = &JunctionPaginationResponse{}
			}
			if err := m.Pagination.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
