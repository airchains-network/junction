...
import (
	...
	modulev1 "github.com/airchains-network/junction/api/junction/zksequencer/module"
	"github.com/airchains-network/junction/x/zksequencer/client/cli"
...
type ModuleInputs struct {
	...
	VrfKeeper vrfkeeper.Keeper // Inject VRF Keeper
...
type ModuleOutputs struct {
	...
	ZksequencerKeeper keeper.Keeper
...
func ProvideModule(in ModuleInputs) ModuleOutputs {
	...
	return ModuleOutputs{ZksequencerKeeper: k, Module: m}
}
