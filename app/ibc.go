...
func (app *App) registerIBCModules(appOpts servertypes.AppOptions, wasmOpts []wasmkeeper.Option) {
	...
	fmt.Println("register the key tables for legacy param subspaces")
	...
	fmt.Println("IBC Keeper initialization")
	// Create IBC keeper
	...
	fmt.Println("ICA Host keeper initialization")
	...
	fmt.Println("ICA Controller Keeper initialization")
