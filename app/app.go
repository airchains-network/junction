...
// any overrides above
var (
	// DefaultNodeHome default home directories for junctiond
...
var (
	_ runtime.AppI            = (*JunctionApp)(nil)
	_ servertypes.Application = (*JunctionApp)(nil)
)

// JunctionApp extended ABCI application
type JunctionApp struct {
	*baseapp.BaseApp
...
// NewJunctionApp returns a reference to an initialized JunctionApp.
func NewJunctionApp(
	logger log.Logger,
	db dbm.DB,
	...
	// Also, create a scope for zksequencer and vrf
	...
	*/
	...
	// see cmd/junctiond/root.go: 206 - 214 approx
...
func (app *JunctionApp) setAnteHandler(txConfig client.TxConfig, wasmConfig wasmtypes.WasmConfig, txCounterStoreKey *storetypes.KVStoreKey) {
...
func (app *JunctionApp) setPostHandler() {
...
func (app *JunctionApp) Name() string { return app.BaseApp.Name() }

// PreBlocker application updates every pre block
func (app *JunctionApp) PreBlocker(ctx sdk.Context, _ *abci.RequestFinalizeBlock) (*sdk.ResponsePreBlock, error) {
	return app.ModuleManager.PreBlock(ctx)
}

// BeginBlocker application updates every begin block
func (app *JunctionApp) BeginBlocker(ctx sdk.Context) (sdk.BeginBlock, error) {
	return app.ModuleManager.BeginBlock(ctx)
}

// EndBlocker application updates every end block
func (app *JunctionApp) EndBlocker(ctx sdk.Context) (sdk.EndBlock, error) {
	return app.ModuleManager.EndBlock(ctx)
}

func (a *JunctionApp) Configurator() module.Configurator {
	return a.configurator
}

// InitChainer application update at chain initialization
func (app *JunctionApp) InitChainer(ctx sdk.Context, req *abci.RequestInitChain) (*abci.ResponseInitChain, error) {
...
func (app *JunctionApp) LoadHeight(height int64) error {
...
func (app *JunctionApp) LegacyAmino() *codec.LegacyAmino {
...
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
func (app *JunctionApp) AppCodec() codec.Codec {
	return app.appCodec
}

// InterfaceRegistry returns JunctionApp's InterfaceRegistry
func (app *JunctionApp) InterfaceRegistry() types.InterfaceRegistry {
	return app.interfaceRegistry
}

// TxConfig returns JunctionApp's TxConfig
func (app *JunctionApp) TxConfig() client.TxConfig {
	return app.txConfig
}

// AutoCliOpts returns the autocli options for the app.
func (app *JunctionApp) AutoCliOpts() autocli.AppOptions {
...
func (a *JunctionApp) DefaultGenesis() map[string]json.RawMessage {
...
func (app *JunctionApp) GetKey(storeKey string) *storetypes.KVStoreKey {
	return app.keys[storeKey]
}

// GetStoreKeys returns all the stored store keys.
func (app *JunctionApp) GetStoreKeys() []storetypes.StoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *JunctionApp) GetTKey(storeKey string) *storetypes.TransientStoreKey {
...
func (app *JunctionApp) GetMemKey(storeKey string) *storetypes.MemoryStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *JunctionApp) GetSubspace(moduleName string) paramstypes.Subspace {
	subspace, _ := app.ParamsKeeper.GetSubspace(moduleName)
	return subspace
}

// SimulationManager implements the SimulationApp interface
func (app *JunctionApp) SimulationManager() *module.SimulationManager {
	return app.sm
}

// RegisterAPIRoutes registers all application module routes with the provided
// API server.
func (app *JunctionApp) RegisterAPIRoutes(apiSvr *api.Server, apiConfig config.APIConfig) {
...
func (app *JunctionApp) RegisterTxService(clientCtx client.Context) {
	authtx.RegisterTxService(app.BaseApp.GRPCQueryRouter(), clientCtx, app.BaseApp.Simulate, app.interfaceRegistry)
}

// RegisterTendermintService implements the Application.RegisterTendermintService method.
func (app *JunctionApp) RegisterTendermintService(clientCtx client.Context) {
...
func (app *JunctionApp) RegisterNodeService(clientCtx client.Context, cfg config.Config) {
