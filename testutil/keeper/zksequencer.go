...
func ZksequencerKeeper(t testing.TB) (keeper.Keeper, sdk.Context) {
	...
	k := keeper.NewKeeper(
		...
		vrfKeeper.NewKeeper(appCodec, runtime.NewKVStoreService(storeKey), log.NewNopLogger(), authority.String(), func() *ibckeeper.Keeper {
			return &ibckeeper.Keeper{
				PortKeeper: &portKeeper,
			}
		}, func(string) capabilitykeeper.ScopedKeeper {
