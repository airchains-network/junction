...
const (
	Query_ContractInfo_FullMethodName       = "/junction.wasm.v1.Query/ContractInfo"
	Query_ContractHistory_FullMethodName    = "/junction.wasm.v1.Query/ContractHistory"
	Query_ContractsByCode_FullMethodName    = "/junction.wasm.v1.Query/ContractsByCode"
	Query_AllContractState_FullMethodName   = "/junction.wasm.v1.Query/AllContractState"
	Query_RawContractState_FullMethodName   = "/junction.wasm.v1.Query/RawContractState"
	Query_SmartContractState_FullMethodName = "/junction.wasm.v1.Query/SmartContractState"
	Query_Code_FullMethodName               = "/junction.wasm.v1.Query/Code"
	Query_Codes_FullMethodName              = "/junction.wasm.v1.Query/Codes"
	Query_PinnedCodes_FullMethodName        = "/junction.wasm.v1.Query/PinnedCodes"
	Query_Params_FullMethodName             = "/junction.wasm.v1.Query/Params"
	Query_ContractsByCreator_FullMethodName = "/junction.wasm.v1.Query/ContractsByCreator"
	Query_BuildAddress_FullMethodName       = "/junction.wasm.v1.Query/BuildAddress"
)
...
func (c *queryClient) ContractHistory(ctx context.Context, in *QueryContractHistoryRequest, opts ...grpc.CallOption) (*QueryContractHistoryResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_ContractHistory_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) ContractsByCode(ctx context.Context, in *QueryContractsByCodeRequest, opts ...grpc.CallOption) (*QueryContractsByCodeResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_ContractsByCode_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) RawContractState(ctx context.Context, in *QueryRawContractStateRequest, opts ...grpc.CallOption) (*QueryRawContractStateResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_RawContractState_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) PinnedCodes(ctx context.Context, in *QueryPinnedCodesRequest, opts ...grpc.CallOption) (*QueryPinnedCodesResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_PinnedCodes_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) ContractsByCreator(ctx context.Context, in *QueryContractsByCreatorRequest, opts ...grpc.CallOption) (*QueryContractsByCreatorResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_ContractsByCreator_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) BuildAddress(ctx context.Context, in *QueryBuildAddressRequest, opts ...grpc.CallOption) (*QueryBuildAddressResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_BuildAddress_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_ContractsByCode_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Query_ContractsByCode_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_PinnedCodes_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Query_PinnedCodes_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_BuildAddress_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Query_BuildAddress_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
