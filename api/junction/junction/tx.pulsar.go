...
var file_junction_junction_tx_proto_rawDesc = []byte{
	...
	0x6e, 0x42, 0x07, 0x54, 0x78, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x22, 0x63, 0x6f,
...
var file_junction_junction_tx_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
...
var file_junction_junction_tx_proto_depIdxs = []int32{
	2, // 0: junction.junction.MsgUpdateParams.params:type_name -> junction.junction.Params
	0, // 1: junction.junction.Msg.UpdateParams:input_type -> junction.junction.MsgUpdateParams
	1, // 2: junction.junction.Msg.UpdateParams:output_type -> junction.junction.MsgUpdateParamsResponse
