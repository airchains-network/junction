...
func initAppConfig() (string, interface{}) {
	...
	srvCfg.MinGasPrices = "0.0025uamf"
...
func appExport(
	...
	var junctionApp *app.JunctionApp
	...
	junctionApp = app.NewJunctionApp(
		logger,
		db,
		traceStore,
		height == -1,
	...
	if height != -1 {
		if err := junctionApp.LoadHeight(height); err != nil {
			return servertypes.ExportedApp{}, err
		}
	}

	return junctionApp.ExportAppStateAndValidators(forZeroHeight, jailAllowedAddrs, modulesToExport)
}

var tempDir = func() string {
	dir, err := os.MkdirTemp("", "junctiond")
	if err != nil {
